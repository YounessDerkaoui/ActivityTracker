...
export class OverviewComponent {
  ...
  cardData = [
    ...
    { title: 'Leaderboard', subtitle: 'Your rank in comparison to other users', imageSrc: '/assets/img/leaderboard.jpg', content: ['Ranked \'15 256\' (Casablanca)', 'Ranked \'2 930 019\' (Morocco)'], icon : 'leaderboard', buttons : ['DETAILS'], share : true },
