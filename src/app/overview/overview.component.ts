...
export class OverviewComponent {
  ...
  cardData = [
    ...
    { title: 'Rewards', subtitle: 'Redeemable Rewards', imageSrc: '/assets/img/Rewards.png', content: ['1 (XRP)', '0.0023 (ETH)'], icon : 'score', buttons : ['DETAILS'], share : false},
    ...
    { title: 'Wallet', subtitle: 'Transactions', imageSrc: '/assets/img/Wallet.png', content: ['Exchange currency', 'Shop products'], icon : 'payment', buttons : ['DETAILS'], share : false },
